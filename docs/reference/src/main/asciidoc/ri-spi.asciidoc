...
`org.jboss.weld.context.beanstore.BeanStore`. You may find
`org.jboss.weld.context.beanstore.ConcurrentHashMapBeanStore` useful.
...
`org.jboss.weld.context.beanstore.BeanStore` should be implemented to
provide an application scoped storage.
