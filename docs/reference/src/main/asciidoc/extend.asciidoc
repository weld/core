...
InjectionTarget<SomeFrameworkComponent> it = beanManager.getInjectionTargetFactory(type).createInjectionTarget(null);

//each instance needs its own CDI CreationalContext
CreationalContext<SomeFrameworkComponent> ctx = beanManager.createCreationalContext(null);
...
public interface BeanAttributes<T> {
   ...
   public default boolean isReserve() { return false; }
   public default boolean isEager() { return false; }
   public default boolean isAutoClose() { return false; }
}
------------------------------------------------------------
