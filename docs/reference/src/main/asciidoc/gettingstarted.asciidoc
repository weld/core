...
GlassFish 5 or better, or any compliant Java EE 8 container.
...
** WildFly 14.0.1.Final (14.0.1.Final recommended),
** GlassFish 5.0,
...
https://javaee.github.io/glassfish/download[GlassFish 5.0] release. Select
