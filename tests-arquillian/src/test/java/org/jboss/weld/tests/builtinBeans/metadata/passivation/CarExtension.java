...
public class CarExtension implements Extension {
    ...
    public void registerCar(@Observes AfterBeanDiscovery event, BeanManager manager) {
        ...
        InjectionTargetFactory<Car> factory = manager.getInjectionTargetFactory(annotatedType);
        this.bean = new PassivationCapableBeanImpl<Car>(Car.class, attributes, factory);
        event.addBean(bean);
    }
}
