...
public class SystemPropertyValueActivationTest {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(JavaArchive.class).addClass(Utils.class).addClasses(Bar.class, Foo.class, Baz.class, Qux.class).addClass(Utils.class).addClasses(SystemPropertyExtension.class).addAsManifestResource(BEANS_XML, "beans.xml").addAsManifestResource("org/jboss/weld/tests/metadata/scanning/SystemPropertyExtension", "services/javax.enterprise.inject.spi.Extension");
    }
