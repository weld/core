...
public class EventsNotFiredForAnonymousClassTest {
    ...
    public void processBeanAttributesEventNotFiredForAnonymousClass() {
        Optional<Class<?>> optionalValue = TestExtension.pbaFiredvalues.stream().filter((Class c) -> c.isAnonymousClass()).findFirst();
    ...
    public void processBeanEventNotFiredForAnonymousClass() {
        Optional<Class<?>> optionalValue = TestExtension.pbFiredValues.stream().filter((Class c) -> c.isAnonymousClass()).findFirst();
