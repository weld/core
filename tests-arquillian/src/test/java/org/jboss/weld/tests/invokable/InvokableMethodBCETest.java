...
public class InvokableMethodBCETest {
    ...
    public void testArgTransformingInvokableMethod() {
        ...
        Assert.assertEquals(expected, synthBean.getArgTransformerWithConsumerInvoker().invoke(transformableBean,
                new Object[] { new FooArg(fooArg), "bar" }));
        Assert.assertEquals(1, ArgTransformer.runnableExecuted);
        Assert.assertEquals(expected, synthBean.getStaticArgTransformerWithConsumerInvoker().invoke(null,
                new Object[] { new FooArg(fooArg), "bar" }));
    ...
    public void testInstanceTransformingInvokableMethod() {
        ...
        Assert.assertEquals(expected, synthBean.getInstanceTransformerWithConsumerInvoker().invoke(targetInstance,
        ...
        targetInstance = new TransformableBean();
        Assert.assertFalse(targetInstance.isTransformed());
        Assert.assertEquals(expected, synthBean.getInstanceTransformerNoParamInvoker().invoke(targetInstance,
                new Object[] { new FooArg(fooArg), fooArg }));
        Assert.assertTrue(targetInstance.isTransformed());
    }
    ...
    public void testReturnValueTransformingInvokableMethod() {
        ...
        Assert.assertEquals(expected, synthBean.getStaticReturnTransformerInvoker().invoke(transformableBean,
                new Object[] { new FooArg(fooArg), fooArg }));

        // transformer on the result class (String), no arg method
        Assert.assertEquals(expected, synthBean.getReturnTransformerNoParamInvoker().invoke(transformableBean,
                new Object[] { new FooArg(fooArg), fooArg }));
        Assert.assertEquals(expected, synthBean.getStaticReturnTransformerNoParamInvoker().invoke(transformableBean,
                new Object[] { new FooArg(fooArg), fooArg }));
    }
