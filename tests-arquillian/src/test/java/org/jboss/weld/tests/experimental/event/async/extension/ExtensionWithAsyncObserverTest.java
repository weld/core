 ...
 */
package org.jboss.weld.tests.experimental.event.async.extension;
...
public class ExtensionWithAsyncObserverTest {
    ...
    public static Archive<?> getDeployment() {
        return ShrinkWrap.create(BeanArchive.class).addPackage(ExtensionWithAsyncObserverTest.class.getPackage())
