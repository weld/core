...
@WebServiceClient(name = "Translator", 
                  targetNamespace = "http://ws.resources.tests.weld.jboss.org/")
public class TranslatorService extends Service {
    ...
    public final static QName TranslatorEndpointPort = new QName("http://ws.resources.tests.weld.jboss.org/", "TranslatorEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("");
