...
public class DecoratedProducerMethodTest {
    ...
    public void testProducerWithDecorator(BeanManager manager) {
        ...
        privateWorker.select(DefaultLiteral.INSTANCE).get().doStuff();
        protectedWorker.select(DefaultLiteral.INSTANCE).get().doStuff();
        publicWorker.select(DefaultLiteral.INSTANCE).get().doStuff();
        packPrivateWorker.select(DefaultLiteral.INSTANCE).get().doStuff();
