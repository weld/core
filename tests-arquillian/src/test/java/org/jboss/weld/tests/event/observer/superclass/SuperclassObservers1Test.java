...
public class SuperclassObservers1Test {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(SuperclassObservers1Test.class)).addPackage(SuperclassObservers1Test.class.getPackage());
    }
