...
public class Specialization03Test {
    ...
    public static Archive<?> getDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, Utils.getDeploymentNameAsHash(Specialization03Test.class, Utils.ARCHIVE_TYPE.WAR)).addClass(InjectedBean1.class)
