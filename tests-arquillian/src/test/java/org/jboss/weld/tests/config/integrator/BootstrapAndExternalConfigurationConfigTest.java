...
public class BootstrapAndExternalConfigurationConfigTest {
    ...
    public static Archive<?> getDeployment() {
        return ShrinkWrap
                ...
                .addAsServiceProvider(Service.class, MyExternalConfiguration.class, MyBootstrapConfiguration.class);
    }
