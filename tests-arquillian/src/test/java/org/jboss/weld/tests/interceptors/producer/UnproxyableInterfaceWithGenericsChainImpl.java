...
@Vetoed
public class UnproxyableInterfaceWithGenericsChainImpl implements InterfaceWithGenericsB<String, Integer> {
    @Override
    public String pong() {
        return UnproxyableInterfaceWithGenericsChainImpl.class.getSimpleName();
    }
