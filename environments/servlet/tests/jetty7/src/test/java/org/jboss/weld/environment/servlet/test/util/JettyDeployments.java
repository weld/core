...
public class JettyDeployments
{
   ...
   public static final Asset JETTY_WEB = new ByteArrayAsset("<Configure id=\"webAppCtx\" class=\"org.eclipse.jetty.webapp.WebAppContext\"><Call class=\"org.jboss.weld.environment.jetty7.WeldServletHandler\" name=\"process\"><Arg><Ref id=\"webAppCtx\"/></Arg></Call></Configure>".getBytes());
