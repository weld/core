...
public class AdditionalBeanDeploymentArchiveTest extends AdditionalBeanDeploymentArchiveTestBase {

    @Deployment
    public static WebArchive createTestArchive() {
        return baseTestArchive().add(CONTEXT_XML, "META-INF/context.xml");
    }
