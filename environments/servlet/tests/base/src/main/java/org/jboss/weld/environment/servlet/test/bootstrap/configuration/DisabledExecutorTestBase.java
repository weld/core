...
public class DisabledExecutorTestBase {
    ...
    public static WebArchive getDeployment() {
        return baseDeployment()
                .addAsResource(new StringAsset("threadPoolType=NONE"), "org.jboss.weld.executor.properties")
                .addClass(DisabledExecutorTestBase.class);
    }
