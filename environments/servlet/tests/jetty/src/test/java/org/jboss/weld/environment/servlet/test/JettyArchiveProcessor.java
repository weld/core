...
/**
 * This processor adds Jetty-specific resources to the test archive.
 *
 * <p>
 ...
 * @author Martin Kouba
 */
public class JettyArchiveProcessor implements ApplicationArchiveProcessor {
    ...
    public void process(Archive<?> applicationArchive, TestClass testClass) {
        ...
        if (applicationArchive instanceof WebArchive) {
            JettyDeployments.apply((WebArchive) applicationArchive);
        } else {
