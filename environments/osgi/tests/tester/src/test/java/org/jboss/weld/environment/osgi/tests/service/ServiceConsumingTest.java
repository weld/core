...
//        Assert.assertEquals("The constructor qualified from property service method result was wrong","org.jboss.weld.osgi.tests.bundle1.impl.impl.PropertyServiceImpl2",constructorQualifiedFromPropertyService.whoAmI());
...
//        Assert.assertEquals("The initializer qualified from property service provider method result was wrong","org.jboss.weld.osgi.tests.bundle1.impl.impl.PropertyServiceImpl2",initializerQualifiedFromPropertyServiceProviderGet.whoAmI());
