 ...
 * a bean bundle goes from one state to another a corresponding {@link org.jboss.weld.environment.osgi.api.events.Valid}
 * or {@link org.jboss.weld.environment.osgi.api.events.Invalid} event may be fired.</p>
 *
