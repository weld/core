 ...
 */
package org.jboss.weld.environment.se.test.beandiscovery.stereotype;
...
public class StereotypeDiscoveryTest {
    ...
    public static Archive<?> getDeployment() {
        return ShrinkWrap.create(BeanArchive.class).annotated().addPackage(StereotypeDiscoveryTest.class.getPackage());
    }
