...
public class BeanDiscoveryDecorator02Test {

    /**
     * Throw exception because of the decorator ClassicInterceptor not accessible, because it has not a bean defining annotation.
     */
    @Deployment
