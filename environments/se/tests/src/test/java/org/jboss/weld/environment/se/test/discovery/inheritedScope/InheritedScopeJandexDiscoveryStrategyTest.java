...
public class InheritedScopeJandexDiscoveryStrategyTest {

    @Deployment
    public static Archive<?> createTestArchive() {
        File jandex = Maven.resolver().resolve("io.smallrye:jandex:3.5.3").withTransitivity().asSingleFile();

        return ClassPath.builder()
                .add(ShrinkWrap.create(BeanArchive.class)
                        .addClasses(InheritedScopeJandexDiscoveryStrategyTest.class, ProperBean.class,
