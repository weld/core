 ...
 * <p>
 * Implementations are not required to support recursive computations. A cache client must be aware that such computations may result in livelocks, infinite
...
public interface ComputingCache<K, V> {
    ...
    /**
     *
     * @return an immutable iterable of values
     */
