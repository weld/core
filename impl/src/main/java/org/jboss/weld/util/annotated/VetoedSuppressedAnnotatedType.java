...
/**
 * Allows a type annotated with {@link Vetoed} to be registered, i.e. {@link Vetoed} annotation is ignored.
 *
...
public class VetoedSuppressedAnnotatedType<T> extends ForwardingAnnotatedType<T> {
    ...
    public static <T> VetoedSuppressedAnnotatedType<T> from(Class<T> clazz, BeanManager beanManager) {
