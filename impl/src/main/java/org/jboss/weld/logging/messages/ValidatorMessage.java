...
public enum ValidatorMessage {
    ...
    @MessageId("001471")INTERCEPTOR_METHOD_SHOULD_NOT_THROW_CHECKED_EXCEPTIONS,
    @MessageId("001472")EVENT_METADATA_INJECTED_OUTSIDE_OF_OBSERVER,
    @MessageId("001473")BEAN_NOT_PASSIVATION_CAPABLE,
    @MessageId("001474")UNSATISFIED_DEPENDENCY_BECAUSE_CLASS_IGNORED,
    @MessageId("001475")UNSATISFIED_DEPENDENCY_BECAUSE_QUALIFIERS_DONT_MATCH,
    @MessageId("001476")INTERCEPTOR_MUST_BE_DEPENDENT
}
