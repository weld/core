...
public enum BeanMessage {
    ...
    @MessageId("001519")INJECTION_TARGET_CREATED_FOR_ABSTRACT_CLASS,
    ...
    @MessageId("001525")DESTROY_UNSUPPORTED,
    @MessageId("001526")PASSIVATING_BEAN_HAS_NON_PASSIVATION_CAPABLE_DECORATOR,
    @MessageId("001527")PASSIVATING_BEAN_HAS_NON_PASSIVATION_CAPABLE_INTERCEPTOR,
    @MessageId("001528")CANNOT_INSTANTIATE_ABSTRACT_CLASS,
    ...
    @MessageId("001533")INJECTION_TARGET_CREATED_FOR_NON_STATIC_INNER_CLASS,
    @MessageId("001534")DECORATED_HAS_NO_NOARGS_CONSTRUCTOR,
    @MessageId("001535")DECORATED_NOARGS_CONSTRUCTOR_IS_PRIVATE,
    @MessageId("001536")PRODUCER_FIELD_WITH_TYPE_VARIABLE_BEAN_TYPE_MUST_BE_DEPENDENT,
    @MessageId("001537")PRODUCER_FIELD_CANNOT_HAVE_A_WILDCARD_BEAN_TYPE,
