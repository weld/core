...
public enum MetadataMessage {
    ...
    @MessageId("001118")TYPE_VARIABLE_IS_NOT_A_VALID_BEAN_TYPE,
    @MessageId("001119")PARAMETERIZED_TYPE_CONTAINING_WILDCARD_PARAMETER_IS_NOT_A_VALID_BEAN_TYPE,
    @MessageId("001120")BEAN_WITH_PARAMETERIZED_TYPE_CONTAINING_TYPE_VARIABLES_MUST_BE_DEPENDENT_SCOPED,
}
