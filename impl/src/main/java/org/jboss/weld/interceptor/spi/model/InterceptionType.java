...
public enum InterceptionType {
    ...
    POST_CONSTRUCT(true, "jakarta.annotation.PostConstruct"),
    PRE_DESTROY(true, "jakarta.annotation.PreDestroy"),
    POST_ACTIVATE(true, "jakarta.ejb.PostActivate"),
    PRE_PASSIVATE(true, "jakarta.ejb.PrePassivate"),
