 ...
 *
 */
public class EventTypeAssignabilityRules2 extends AbstractAssignabilityRules {

    private static final AssignabilityRules INSTANCE = new EventTypeAssignabilityRules2();

    public static AssignabilityRules instance() {
        return INSTANCE;
    }

    private EventTypeAssignabilityRules2() {
    }
