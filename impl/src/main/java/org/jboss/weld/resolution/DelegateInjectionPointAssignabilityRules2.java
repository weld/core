 ...
 * @author Matus Abaffy
 */
public class DelegateInjectionPointAssignabilityRules2 extends BeanTypeAssignabilityRules2 {

    private static final AssignabilityRules INSTANCE = new DelegateInjectionPointAssignabilityRules2();
