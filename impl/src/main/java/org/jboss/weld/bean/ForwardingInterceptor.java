...
/**
 * Delegating implementation of {@link Interceptor}.
 *
 * @author Jozef Hartinger
 *
 */
public abstract class ForwardingInterceptor<T> extends IsolatedForwardingInterceptor<T> implements Interceptor<T> {
