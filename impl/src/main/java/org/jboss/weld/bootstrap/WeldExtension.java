...
import org.jboss.weld.context.activator.ActivateRequestScopeInterceptor;
...
class WeldExtension implements Extension {
    ...
    void beforeBeanDiscovery(@Observes BeforeBeanDiscovery event, BeanManager beanManager) {
        event.addAnnotatedType(VetoedSuppressedAnnotatedType.from(ActivateRequestScopeInterceptor.class, beanManager),
