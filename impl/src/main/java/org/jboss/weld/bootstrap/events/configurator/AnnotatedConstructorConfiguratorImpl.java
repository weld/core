 ...
 * @param <T>
 */
public class AnnotatedConstructorConfiguratorImpl<T> extends AnnotatedCallableConfigurator<T, AnnotatedConstructor<T>, AnnotatedConstructorConfiguratorImpl<T>>
