...
public class ClassWithNestedClasses {
    ...
    public ClassWithNestedClasses() {
        ...
        this.constructorLocalClass = ConstructorLocalClass.class;
    }
    ...
    public static Class<?> getMethodLocalClass() {
        class MethodLocalClass {
        }
        return MethodLocalClass.class;
    }

    public Class<?> getConstructorLocalClass() {
        return constructorLocalClass;
    }
