...
public class Playground_Cleanup {
    public static void main(String[] args) throws Throwable {
        ...
        MethodHandle cleanupMethod = mh.type().returnType() == void.class
                ? MethodHandleUtils.createMethodHandle(CleanupActions.class.getDeclaredMethod("run", Throwable.class, CleanupActions.class))
                : MethodHandleUtils.createMethodHandle(CleanupActions.class.getDeclaredMethod("run", Throwable.class, Object.class, CleanupActions.class));
